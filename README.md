...
<!--
Public IP address is 13.235.113.203.
ssh -i ~/.ssh/lightsail_key.rsa ubuntu@13.235.113.203
-->
...
<!--
Public IP address is 13.235.113.203.
ssh -i ~/.ssh/lightsail_key.rsa -p 2200 ubuntu@13.235.113.203
-->
...
- Logged back in, and I now see this message:
  ```
  Alains-MBP:udacity-linux-server-configuration boisalai$ ssh -i ~/.ssh/lightsail_key.rsa -p 2200 ubuntu@13.235.113.203
...
- On the grader's virtual machine:
  ...
  - Restart SSH: `sudo service ssh restart`
- On the local machine, run: `ssh -i ~/.ssh/grader_key -p 2200 grader@13.235.113.203`.

<!--
Public IP address is 13.235.113.203.
ssh -i ~/.ssh/grader_key -p 2200 grader@13.235.113.203
...
- Open your browser to http://13.235.113.203
